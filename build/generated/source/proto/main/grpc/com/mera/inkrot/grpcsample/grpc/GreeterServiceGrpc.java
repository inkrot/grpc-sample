...
public final class GreeterServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.mera.inkrot.grpcsample.grpc.HelloRequest,
      com.mera.inkrot.grpcsample.grpc.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.mera.inkrot.grpcsample.grpc.HelloRequest.class,
      responseType = com.mera.inkrot.grpcsample.grpc.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.mera.inkrot.grpcsample.grpc.HelloRequest,
      com.mera.inkrot.grpcsample.grpc.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.mera.inkrot.grpcsample.grpc.HelloRequest, com.mera.inkrot.grpcsample.grpc.HelloResponse> getSayHelloMethod;
      ...
      synchronized (GreeterServiceGrpc.class) {
        if ((getSayHelloMethod = GreeterServiceGrpc.getSayHelloMethod) == null) {
          GreeterServiceGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<com.mera.inkrot.grpcsample.grpc.HelloRequest, com.mera.inkrot.grpcsample.grpc.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.mera.inkrot.grpcsample.grpc.GreeterService", "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mera.inkrot.grpcsample.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mera.inkrot.grpcsample.grpc.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class GreeterServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.mera.inkrot.grpcsample.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.mera.inkrot.grpcsample.grpc.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.mera.inkrot.grpcsample.grpc.HelloRequest,
                com.mera.inkrot.grpcsample.grpc.HelloResponse>(
  ...
  public static final class GreeterServiceBlockingStub extends io.grpc.stub.AbstractStub<GreeterServiceBlockingStub> {
    ...
    /**
     */
    public com.mera.inkrot.grpcsample.grpc.HelloResponse sayHello(com.mera.inkrot.grpcsample.grpc.HelloRequest request) {
  ...
  public static final class GreeterServiceFutureStub extends io.grpc.stub.AbstractStub<GreeterServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.mera.inkrot.grpcsample.grpc.HelloResponse> sayHello(
        com.mera.inkrot.grpcsample.grpc.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.mera.inkrot.grpcsample.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.mera.inkrot.grpcsample.grpc.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreeterServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.mera.inkrot.grpcsample.grpc.GreeterServiceOuterClass.getDescriptor();
    }
